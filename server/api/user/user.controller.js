    ...
    if(err) return res.send(500, err);
      ...
      for(var i=0; i<users.length;i++){
        ...
        if(users[i].avisos.length>0){
          console.log('Total de avisos para el usuario: '+users[i].username+ ' son de: '+users[i].avisos.length);
          //for(var numavisos=0; numavisos<users[i].avisos.length;++numavisos) 
          var numavisos=0;
